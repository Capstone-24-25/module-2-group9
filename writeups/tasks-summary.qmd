...
Including header content does not seem to improve predictions. When using only paragraphs
content, we obtain an accuracy of 0.835. However, when using both paragraphs and headers content, we obtain an accuracy of 0.759.
